### На основе протестированных требований к странице авторизации компании "Ростелеком", созданы позитивные и негативные тестовые сценарии, с использованием техник тест-дизайна  
#### Тестовые сценарии:
EXP-001  
