...
class RegistrationEmail(BasePage):
    ...
    def search_email_confirmation(self):
        assert self.find_element(RegistrationLocators.EMAIL_CONFIRMATION)
        with allure.step('Успешный переход на страницу "Подтверждение почты"'):
            pass
